...
class HomeViewModelFactory (private val iProducts: CollectionsRepo, var products: ProductsRepo, private var iCurrency: StoredCurrency) : ViewModelProvider.Factory {
